...
com.data = function data() {
    ...
    return {
        title: `页面设置:${this.pfile?this.pfile.name:'未知'}`,
...
com.mounted = function () {
    var ctx = this;
    var randName = `untitled${String(Math.random()).substr(3, 4)}.html`;
    if (!ctx.conf.pageName) ctx.$set(ctx.conf, 'pageName', randName);
};
