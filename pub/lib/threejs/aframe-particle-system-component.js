        ...
        AFRAME.registerComponent('particle-system', {
            ...
            init: function () {
                ...
                this.presets['default'] = {
                    ...
                    positionSpread: (this.data.positionSpread.x !== 0 || this.data.positionSpread.y !== 0 || this.data.positionSpread.z !== 0 ? this.data.positionSpread : {
                        x: 0,
                        y: 0,
                        z: 0
                    }),
                    type: (this.data.type !== 0 ? this.data.type : SPE.distributions.SPHERE),
                    ...
                    accelerationValue: (this.data.accelerationValue.x !== 0 || this.data.accelerationValue.y !== 0 || this.data.accelerationValue.z !== 0 ? this.data.accelerationValue : {
                        x: 0,
                        y: -10,
                        z: 0
                    }),
                    accelerationSpread: (this.data.accelerationSpread.x !== 0 || this.data.accelerationSpread.y !== 0 || this.data.accelerationSpread.z !== 0 ? this.data.accelerationSpread : {
                        x: 10,
                        y: 0,
                        z: 10
                    }),
                    velocityValue: (this.data.velocityValue.x !== 0 || this.data.velocityValue.y !== 0 || this.data.velocityValue.z !== 0 ? this.data.velocityValue : {
                        x: 0,
                        y: 25,
                        z: 0
                    }),
                    velocitySpread: (this.data.velocitySpread.x !== 0 || this.data.velocitySpread.y !== 0 || this.data.velocitySpread.z !== 0 ? this.data.velocitySpread : {
                        x: 10,
                        y: 7.5,
                        z: 10
                    }),
                    ...
                    opacity: {
                        value: (this.data.opacity != 0 ? this.data.opacity : 1)
                    },
            ...
            initParticleSystem: function (settings) {
                ...
                settings.type = SPE.distributions.SPHERE;
                ...
                opt={
            		...
            		position: {
                        value: new THREE.Vector3(0,5,-15),
                        radius: 5,
